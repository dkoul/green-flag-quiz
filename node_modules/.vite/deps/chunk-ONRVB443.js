...
// node_modules/@patternfly/pfe-core/controllers/internals-controller.js
...
function aria(target, key) {
  if (!protos.has(target)) {
    protos.set(target, /* @__PURE__ */ new Set());
  }
...
function getLabelText(label) {
  ...
  if (label.hidden) {
    ...
    const ariaLabel = (_a3 = label.getAttribute) == null ? void 0 : _a3.call(label, "aria-label");
    return ariaLabel ?? label.textContent;
  }
}
var InternalsController = class _InternalsController {
  static getLabels(host) {
    var _a3;
    return Array.from(((_a3 = this.instances.get(host)) == null ? void 0 : _a3.internals.labels) ?? []);
  }
  static of(host, options) {
    constructingAllowed = true;
    const instance = _InternalsController.instances.get(host) ?? new _InternalsController(host, options);
  ...
  get formDisabled() {
    ...
    if (isServer) {
      ...
      return ((_a3 = this.element) == null ? void 0 : _a3.matches(":disabled")) || this._formDisabled;
    }
  }
  get labels() {
  ...
  get element() {
    ...
    if (isServer) {
      ...
      return this.host instanceof HTMLElement ? this.host : (_b2 = (_a3 = this.options) == null ? void 0 : _a3.getHTMLElement) == null ? void 0 : _b2.call(_a3);
    }
  }
  constructor(host, options) {
    ...
    _InternalsController.instances.set(host, this);
  ...
  initializeOptions(options) {
    ...
    const { getHTMLElement, ...aria2 } = this.options;
    (_a3 = this.options).getHTMLElement ?? (_a3.getHTMLElement = getHTMLElement);
    for (const [key, val] of Object.entries(aria2)) {
      if (isARIAMixinProp(key)) {
        this[key] = val;
      }
    }
  ...
  submit() {
    var _a3;
    (_a3 = this.internals.form) == null ? void 0 : _a3.requestSubmit();
  }
  reset() {
    var _a3;
    (_a3 = this.internals.form) == null ? void 0 : _a3.reset();
  }
};
_InternalsController_instances = /* @__PURE__ */ new WeakSet(), _InternalsController_polyfillDisabledPseudo = function _InternalsController_polyfillDisabledPseudo2() {
  const orig = this.element.formDisabledCallback;
  this.element.formDisabledCallback = (disabled) => {
    this._formDisabled = disabled;
    orig == null ? void 0 : orig.call(this.host, disabled);
  };
};
...
lit-html/development/directives/style-map.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ONRVB443.js.map
