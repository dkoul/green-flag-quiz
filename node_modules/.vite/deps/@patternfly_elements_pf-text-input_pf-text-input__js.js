import {
  ...
  property,
  styleMap
} from "./chunk-Q3KOY7FY.js";
import "./chunk-ROME4SDB.js";

// node_modules/@patternfly/elements/pf-text-input/pf-text-input.js
var _PfTextInput_instances;
var _PfTextInput_internals;
var _PfTextInput_derivedLabel;
var _PfTextInput_touched;
var _PfTextInput_disabled_get;
var _PfTextInput_input_get;
var _PfTextInput_onInput;
var _PfTextInput_onKeydown;
var _PfTextInput_onBlur;
var _PfTextInput_setValidityFromInput;
...
var PfTextInput = class PfTextInput2 extends LitElement {
  constructor() {
    super(...arguments);
...
_PfTextInput_internals = /* @__PURE__ */ new WeakMap();
_PfTextInput_derivedLabel = /* @__PURE__ */ new WeakMap();
_PfTextInput_touched = /* @__PURE__ */ new WeakMap();
_PfTextInput_instances = /* @__PURE__ */ new WeakSet();
_PfTextInput_disabled_get = function _PfTextInput_disabled_get2() {
  return !isServer && this.matches(":disabled") || this.disabled;
};
_PfTextInput_input_get = function _PfTextInput_input_get2() {
  var _a;
  return ((_a = this.shadowRoot) == null ? void 0 : _a.getElementById("input")) ?? null;
};
_PfTextInput_onInput = function _PfTextInput_onInput2(event) {
...
_PfTextInput_onKeydown = function _PfTextInput_onKeydown2(event) {
  var _a;
  switch (event.key) {
    case "Enter":
      if (this.reportValidity()) {
        (_a = __classPrivateFieldGet(this, _PfTextInput_internals, "f").form) == null ? void 0 : _a.requestSubmit(null);
      }
  }
};
_PfTextInput_onBlur = function _PfTextInput_onBlur2() {
  if (this.validateOn === "blur") {
    this.checkValidity();
  }
};
_PfTextInput_setValidityFromInput = function _PfTextInput_setValidityFromInput2() {
  var _a;
  __classPrivateFieldGet(this, _PfTextInput_internals, "f").setValidity((_a = __classPrivateFieldGet(this, _PfTextInput_instances, "a", _PfTextInput_input_get)) == null ? void 0 : _a.validity, this.errorText ?? __classPrivateFieldGet(this, _PfTextInput_instances, "a", _PfTextInput_input_get).validationMessage);
  this.requestUpdate();
};
...
//# sourceMappingURL=@patternfly_elements_pf-text-input_pf-text-input__js.js.map
